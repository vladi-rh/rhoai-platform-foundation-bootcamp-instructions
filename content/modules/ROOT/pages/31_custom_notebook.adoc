...
----
+
.If you get an error saying "repository not found" or you are asked for GitHub username/password for cloning  (e.g. inside builder container)
[%collapsible]
====
Go to the https://github.com/settings/personal-access-tokens and create Personal Access Token, than clone git repo using following command: 
