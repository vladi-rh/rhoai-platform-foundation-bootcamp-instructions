...
. Next lets create a new overlay named `parasol-insurance-dev`. Copy `componets/argocd/apps/overlays/eus-2.16` and paste it as `components/argocd/apps/overlays/parasol-insurance-dev`.
