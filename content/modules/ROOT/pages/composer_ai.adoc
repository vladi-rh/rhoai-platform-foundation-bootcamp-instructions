...
To provision a Composer AI environment, you can use the following link: https://catalog.demo.redhat.com/catalog?search=Composer+AI&item=babylon-catalog-prod%2Fsandboxes-gpte.ocp4-composer-ai.prod [Composer AI]
...
+
[.bordershadow]
image::composer_select_assistant.png[]
